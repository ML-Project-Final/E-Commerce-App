...
def make_recommendations():
    try:
        ...
        if request.content_type == 'application/json':
            ...
            username = data.get('username', None)  # Replace 'username' with the actual key in your JSON data
        else:
        ...
        print(transform_ratedproducts, flush=True)
